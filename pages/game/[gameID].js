...
export default function GameDetails({ gameID, coverImage, name, overview, criticReviews, userReviews, systemRequirements, users }) {
  ...
  return (
    <main>
      ...
      <div>
        <div className="relative w-full h-[33.33vh] z-[-1]">
          <Image
            ...
            priority
          />
          <div className="absolute bottom-0 px-6 z-[1] sm:px-10 md:px-14">
      ...
      <section className="px-6 py-12 flex gap-2 overflow-auto bg-[#1a1a1a] [&>button]:game-tab sm:px-10 md:px-14">
        <button
